...
class FlutterParaRookies extends StatefulWidget {
  const FlutterParaRookies({Key? key}) : super(key: key);

  @override
  _FlutterParaRookiesState createState() => _FlutterParaRookiesState();
}

class _FlutterParaRookiesState extends State<FlutterParaRookies> {
  ...
  static int likes = 37; // Variable para llevar un registro de los "likes"
