...
class UnDiaEnElMundoDelFront extends StatefulWidget {
  const UnDiaEnElMundoDelFront({Key? key}) : super(key: key);

  @override
  _UnDiaEnElMundoDelFrontState createState() => _UnDiaEnElMundoDelFrontState();
}

class _UnDiaEnElMundoDelFrontState extends State<UnDiaEnElMundoDelFront> {
  ...
  static int likes = 14; // Variable para llevar un registro de los "likes"
